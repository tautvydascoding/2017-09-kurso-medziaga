...
function createArticle($question, $answer, $topic_id ) {
    $sql_string = sprintf("INSERT INTO duk
                       VALUES ('', '%s', '%s', NOW(), $topic_id)",
...
function editArticle($id, $question, $answer, $topic_id) {
    $sql_text = sprintf("UPDATE duk
                            SET
                                title = '%s',
                                content = '%s',
                                user_id = '$topic_id'
